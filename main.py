...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='/content/LA/LA/LA/', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
    ...
    # Auxiliary arguments
    parser.add_argument('--track', type=str, default='LA',choices=['LA'], help='LA/PA')
    ...
    assert track in ['LA'], 'Invalid track given'
    ...
    if args.eval:
        ...
        file_eval_cleaned = [line.split()[1].split('-')[0] + ".flac" for line in file_eval]

        # Pass the cleaned file list
        eval_set = Dataset_ASVspoof2021_eval(
            list_IDs=file_eval_cleaned,
            base_dir=os.path.join(args.database_path, 'ASVspoof2019_{}_eval/'.format(args.track))
        ) 
